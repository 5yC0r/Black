...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/products.png"))); // NOI18N
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/18871160_1323438661074741_1415227982_n.png"))); // NOI18N
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/carts1111.png"))); // NOI18N
        ...
        jButton8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/cumple.png"))); // NOI18N
        jButton8.setText("Cumpleaños");
        ...
        jButton9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/smartphone (1).png"))); // NOI18N
        jButton9.setText("Recarga");
        ...
        jMenuItem10.setText("Bonos y Comisiones");
        jMenu4.add(jMenuItem10);

        jMenu16.setText("Recargas");

        jMenuItem25.setText("Nueva Recarga");
        jMenu16.add(jMenuItem25);

        jMenuItem26.setText("Operadores Tel.");
        ...
        jMenuItem22.setText("Registro de Producto");
        ...
        jMenuItem20.setText("Nueva Categoria");
        jMenu10.add(jMenuItem20);

        jMenuItem21.setText("Modificar Categoria");
        ...
        jMenuItem14.setText("Registro de Proveedor");
        jMenu8.add(jMenuItem14);

        jMenuItem15.setText("Listado de Proveedores");
        jMenu8.add(jMenuItem15);

        menuBarPrincipal.add(jMenu8);
